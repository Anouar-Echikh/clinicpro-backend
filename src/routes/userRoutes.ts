...
const updateProfileValidation = [
  ...
  body('base_currency').optional().isIn(['USD', 'EUR', 'GBP', 'CAD', 'AUD', 'JPY', 'CNY', 'INR', 'AED', 'SAR', 'NGN', 'VND', 'DOP', 'TZS']).withMessage('Invalid currency code'),
  ...
  body('timezone').optional().trim().isLength({ min: 1, max: 100 }).withMessage('Invalid timezone')
];
