...
const defaultPermissions = [
  ...
  // PATIENT PORTAL MODULE (Patient-only permissions)
  { name: 'patient_portal.view_own_appointments', display_name: 'View Own Appointments', description: 'View own appointment history and schedules', module: 'patient_portal', action: 'view', level: 'view' },
  { name: 'patient_portal.view_own_prescriptions', display_name: 'View Own Prescriptions', description: 'View own prescription history', module: 'patient_portal', action: 'view', level: 'view' },
  { name: 'patient_portal.view_own_invoices', display_name: 'View Own Invoices', description: 'View own billing invoices', module: 'patient_portal', action: 'view', level: 'view' },
  { name: 'patient_portal.view_own_medical_records', display_name: 'View Own Medical Records', description: 'View own medical history and records', module: 'patient_portal', action: 'view', level: 'view' }
];
